# This is copied from https://github.com/keras-team/keras/blob/v2.7.0/keras/layers/multi_head_attention.py#L123-L509, since I got limited by the sever's cuda version so I cannot use the version of tensorflow that support multiheadattention. Slightly modified the import so it fits in TF2.3.0
